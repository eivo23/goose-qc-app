...
export const REASONS: Record<string, string> = {
  ...
  grade_mismatch: 'דרגת המשקל (הריבוע) על הקרטון אינה תואמת לדרגה שהוזמנה',
  missing_stars: 'הוזמן כבד פרוס אך על הקרטון אין 2 כוכביות (סימון "פרוס")',
  grade_unreadable: 'לא ניתן לקרוא בוודאות את דרגת המשקל (הריבוע) על הקרטון',
  stars_unreadable: 'לא ניתן לספור בוודאות את הכוכביות (סימון "פרוס") על הקרטון',
